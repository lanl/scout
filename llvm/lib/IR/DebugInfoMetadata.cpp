...
// +===== Scout ===================================================
DIScoutDerivedType *DIScoutDerivedType::getImpl(
    LLVMContext &Context, unsigned Tag, MDString *Name, Metadata *File,
    unsigned Line, Metadata *Scope, Metadata *BaseType, uint64_t SizeInBits,
    uint64_t AlignInBits, uint64_t OffsetInBits, unsigned Flags,
    unsigned ScoutFlags,
    Metadata *ExtraData, StorageType Storage, bool ShouldCreate) {
  assert(isCanonical(Name) && "Expected canonical MDString");
  DEFINE_GETIMPL_LOOKUP(DIScoutDerivedType, (Tag, getString(Name), File, Line, Scope,
                                        BaseType, SizeInBits, AlignInBits,
                                        OffsetInBits, Flags, ScoutFlags, ExtraData));
  Metadata *Ops[] = {File, Scope, Name, BaseType, ExtraData};
  DEFINE_GETIMPL_STORE(
    DIScoutDerivedType, (Tag, Line, SizeInBits, AlignInBits, OffsetInBits, Flags, ScoutFlags),
      Ops);
}
// +===============================================================
...
// +===== Scout ===================================================
DIScoutCompositeType *DIScoutCompositeType::getImpl(
  LLVMContext &Context, unsigned Tag, MDString *Name, Metadata *File,
  unsigned Line, Metadata *Scope, Metadata *BaseType, uint64_t SizeInBits,
  uint64_t AlignInBits, uint64_t OffsetInBits, unsigned Flags,
  Metadata *Elements, unsigned RuntimeLang, Metadata *VTableHolder,
  ...
  StorageType Storage, bool ShouldCreate) {
  assert(isCanonical(Name) && "Expected canonical MDString");
  DEFINE_GETIMPL_LOOKUP(DIScoutCompositeType,
                        (Tag, getString(Name), File, Line, Scope, BaseType,
                         SizeInBits, AlignInBits, OffsetInBits, Flags, Elements,
                         RuntimeLang, VTableHolder, TemplateParams,
  ...
  Metadata *Ops[] = {File,     Scope,        Name,           BaseType,
    Elements, VTableHolder, TemplateParams, Identifier};
  DEFINE_GETIMPL_STORE(DIScoutCompositeType, (Tag, Line, RuntimeLang, SizeInBits,
                                         AlignInBits, OffsetInBits, Flags,
                                         DimX, DimY, DimZ),
                       Ops);
}
