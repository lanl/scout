...
DoallToPTX2::DoallToPTX2()
  : ModulePass(ID)
{
}

ModulePass *createDoallToPTX2Pass() {
  return new DoallToPTX2();
}

void DoallToPTX2::getAnalysisUsage(AnalysisUsage &AU) const {
  AU.addRequired<DominatorTree>();
}

const char *DoallToPTX2::getPassName() const {
  return "Doall-to-PTX2";
}
...
void DoallToPTX2::identifyDependentFns(FnSet &fnSet, llvm::Function *FN) {
...
void DoallToPTX2::pruneModule(Module &module, ValueToValueMapTy &valueMap,
                             Function &FN) {
  PassManager pm;
...
Module *DoallToPTX2::CloneModule(const Module *M, ValueToValueMapTy &VMap) {
...
namespace{
  ...
  public:
    ForAllVisitor(Module& module, DoallToPTX2::FunctionMDMap& functionMDMap)
      : module(module),
    ...
    ValueMap valueMap;
    Module& module;
    DoallToPTX2::FunctionMDMap& functionMDMap;
  };
