...
#include "llvm/IR/DebugInfoFlags.def"
  ...
  static bool classof(const Metadata *MD) {
    ...
    // +====== Scout ==========================
    case DIScoutCompositeTypeKind:
    case DIScoutDerivedTypeKind:
    // +=======================================
...
public:
  ...
  static bool classof(const Metadata *MD) {
    ...
    // +====== Scout =======================
           MD->getMetadataID() == DIScoutDerivedTypeKind ||
           MD->getMetadataID() == DIScoutCompositeTypeKind ||
    // +====================================
...
class DIScoutDerivedType : public DIDerivedTypeBase {
  ...
  DIScoutDerivedType(LLVMContext &C, StorageType Storage, unsigned Tag,
                unsigned Line, uint64_t SizeInBits, uint64_t AlignInBits,
  ...
  TempDIScoutDerivedType cloneImpl() const {
    return getTemporary(getContext(), getTag(), getName(), getFile(), getLine(),
                        getScope(), getBaseType(), getSizeInBits(),
                        getAlignInBits(), getOffsetInBits(), getFlags(),
                        getScoutFlags(),
...
public:
  ...
  static bool classof(const Metadata *MD) {
    return MD->getMetadataID() == DIScoutDerivedTypeKind;
  }
};
// +=========================================================
...
class DIScoutCompositeType : public DICompositeTypeBase {
  ...
  DIScoutCompositeType(LLVMContext &C, StorageType Storage, unsigned Tag,
                  unsigned Line, unsigned RuntimeLang, uint64_t SizeInBits,
                  uint64_t AlignInBits, uint64_t OffsetInBits, unsigned Flags,
  ...
  TempDIScoutCompositeType cloneImpl() const {
    return getTemporary(getContext(), getTag(), getName(), getFile(), getLine(),
                        getScope(), getBaseType(), getSizeInBits(),
                        getAlignInBits(), getOffsetInBits(), getFlags(),
                        getElements(), getRuntimeLang(), getVTableHolder(),
...
public:
  ...
  static bool classof(const Metadata *MD) {
    return MD->getMetadataID() == DIScoutCompositeTypeKind;
  }
};
// +=============================================================
