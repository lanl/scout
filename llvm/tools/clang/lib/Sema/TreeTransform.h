...
// SC_TODO - I have no clue if this is correct... 
template<typename Derived>
QualType
TreeTransform<Derived>::TransformWindowType(TypeLocBuilder &TLB,
                                            WindowTypeLoc TL) {
...
template<typename Derived>
QualType
TreeTransform<Derived>::TransformImageType(TypeLocBuilder &TLB,
                                           ImageTypeLoc TL) {
