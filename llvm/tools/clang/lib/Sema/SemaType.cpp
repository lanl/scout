...
static QualType ConvertDeclSpecToType(TypeProcessingState &state) {
  ...
  break;
  case DeclSpec::TST_bool3:
    Result = Context.Bool3Ty;  
    break;
  case DeclSpec::TST_bool4:
    Result = Context.Bool4Ty;  
    break;
  case DeclSpec::TST_char2:
    Result = Context.Char2Ty;  
    break;
  case DeclSpec::TST_char3:
    Result = Context.Char3Ty;  
    break;
  case DeclSpec::TST_char4:
    Result = Context.Char4Ty;  
    break;
  case DeclSpec::TST_short2:
    Result = Context.Short2Ty;  
    break;
  case DeclSpec::TST_short3:
    Result = Context.Short3Ty;  
    break;
  case DeclSpec::TST_short4:
    Result = Context.Short4Ty;  
    break;
  case DeclSpec::TST_int2:
    Result = Context.Int2Ty;  
    break;
  case DeclSpec::TST_int3:
    Result = Context.Int3Ty;  
    break;
  case DeclSpec::TST_int4:
    Result = Context.Int4Ty;  
    break;
  case DeclSpec::TST_long2:
    Result = Context.Long2Ty;  
    break;
  case DeclSpec::TST_long3:
    Result = Context.Long3Ty;  
    break;
  case DeclSpec::TST_long4:
    Result = Context.Long4Ty;  
    break;
  case DeclSpec::TST_float2:
    Result = Context.Float2Ty;  
    break;
  case DeclSpec::TST_float3:
    Result = Context.Float3Ty;  
    break;
  case DeclSpec::TST_float4:
    Result = Context.Float4Ty;  
    break;
  case DeclSpec::TST_double2:
    Result = Context.Double2Ty;  
    break;
  case DeclSpec::TST_double3:
    Result = Context.Double3Ty;  
    break;
