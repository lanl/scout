...
class CGDebugInfo {
  ...
  *createMeshFieldType(const MeshFieldDecl *field,
  ...
  llvm::MDType *CreateType(const WindowType *Ty);
  llvm::MDType *CreateType(const ImageType *Ty);
  
  llvm::MDType *CreateType(const QueryType *Ty);
  
  llvm::MDType *CreateType(const FrameType *Ty);
  
  llvm::MDType *CreateType(const FrameVarType *Ty);
  // +========================================================================+
