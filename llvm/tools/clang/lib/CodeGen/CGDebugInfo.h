...
private:
  ...
  /// \brief Create a forward decl for a uniform mesh in a given context.
  llvm::DIScoutCompositeType *getOrCreateMeshFwdDecl(const ALEMeshType *,
                                                     llvm::DIScope *);
  
  /// \brief Create a forward decl for a rectilinear mesh in a given context.
  llvm::DIScoutCompositeType *getOrCreateMeshFwdDecl(const RectilinearMeshType *,
                                                     llvm::DIScope *);
  
  /// \brief Create a forward decl for a structured mesh in a given context.
  llvm::DIScoutCompositeType *getOrCreateMeshFwdDecl(const StructuredMeshType *,
                                                     llvm::DIScope *);
  
  /// \brief Create a forward decl for a unstructured mesh in a given context.
  llvm::DIScoutCompositeType *getOrCreateMeshFwdDecl(const UnstructuredMeshType *,
                                                     llvm::DIScope *);
  
  llvm::DIScoutCompositeType *getOrCreateFrameFwdDecl(const FrameType *,
                                                      llvm::DIScope *);
