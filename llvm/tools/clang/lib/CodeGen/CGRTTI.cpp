...
#include "clang/AST/TypeNodes.def"
  ...
  case Type::UniformMesh:
    VTableName = "_ZTVN10__cxxabiv???__uni_mesh_type_infoE";
  case Type::StructuredMesh:
    VTableName = "_ZTVN10__cxxabiv???__struct_mesh_type_infoE";
  case Type::RectilinearMesh:
    VTableName = "_ZTVN10__cxxabiv???__rect_mesh_type_infoE";
...
#include "clang/AST/TypeNodes.def"
  ...
  //
  // See Record below for what might be needed...
  case Type::UniformMesh:
  case Type::StructuredMesh:
  case Type::RectilinearMesh:
  case Type::UnstructuredMesh:
