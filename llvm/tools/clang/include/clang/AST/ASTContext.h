...
private:
  ...
  // +===== Scout ============================================================+
  llvm::DenseMap<MeshFieldDecl *, MeshFieldDecl *>
    InstantiatedFromUnnamedMeshFieldDecl;
  // +========================================================================+
...
public:
  ...
  void setInstantiatedFromUnnamedFieldDecl(MeshFieldDecl *Inst,
                                           MeshFieldDecl *Tmpl);
  // +========================================================================+
...
public:
  ...
  // +===== Scout ============================================================+
  bool CompareMeshTypes(const Type *T1, const Type *T2);
