...
int main() {
  ...
  __apple_block aid a1;
  __apple_block id a2 __attribute__((aligned(2)));
  __apple_block id a3 __attribute__((aligned(4)));
  __apple_block id a4 __attribute__((aligned(8)));
  __apple_block id a5, a6, a7;
  __apple_block void (^b)();
