...
// CHECK: blocks.c:8:17: VarDecl=i:8:17 (Definition) Extent=[8:3 - 8:22]
// CHECK: blocks.c:8:21: IntegerLiteral= Extent=[8:21 - 8:22]
...
// CHECK: blocks.c:9:54: DeclRefExpr=i:8:17 Extent=[9:54 - 9:55]
