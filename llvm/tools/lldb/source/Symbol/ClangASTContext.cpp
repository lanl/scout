    ...
    switch (tag)
    {
      ...
      case DW_TAG_SCOUT_unstructured_mesh_type:
      {
        ...
        if (!layout_info.field_offsets.empty())
        {
          ...
          clang::MeshDecl *mesh_decl = GetAsMeshDecl(clang_type);
                    ...
                    if (!clang_type)
                    {
                        ...
                        if (!clang_type_was_created)
                        {
                          ...
                          if(isScoutType){
                            ...
                            const uint32_t dimY =
                            die->GetAttributeValueAsUnsigned(dwarf, dwarf_cu, DW_AT_SCOUT_mesh_dim_y, 0);
                            
                            const uint32_t dimZ =
                            die->GetAttributeValueAsUnsigned(dwarf, dwarf_cu, DW_AT_SCOUT_mesh_dim_z, 0);
                            
                            
                            
                            switch(tag){
                              case DW_TAG_SCOUT_uniform_mesh_type:
                                clang_type = CreateUniformMeshType (decl_ctx,
                                                                    accessibility,
                                                                    type_name_cstr,
                                                                    dimX,
                                                                    dimY,
                              ...
                              case DW_TAG_SCOUT_ALE_mesh_type:
                                clang_type = CreateALEMeshType (decl_ctx,
                                                                accessibility,
                                                                type_name_cstr,
                                                                dimX,
                                                                dimY,
                              ...
                              case DW_TAG_SCOUT_structured_mesh_type:
                                clang_type = CreateStructuredMeshType (decl_ctx,
                                                                       accessibility,
                                                                       type_name_cstr,
                                                                       dimX,
                                                                       dimY,
                                ...
                                break;
                              case DW_TAG_SCOUT_rectilinear_mesh_type:
                                clang_type = CreateRectilinearMeshType (decl_ctx,
                                                                        accessibility,
                                                                        type_name_cstr,
                                                                        dimX,
                                                                        dimY,
                                ...
                                break;
                              case DW_TAG_SCOUT_unstructured_mesh_type:
                                clang_type = CreateUnstructuredMeshType (decl_ctx,
                                                                         accessibility,
                                                                         type_name_cstr,
                                                                         dimX,
                                                                         dimY,
                                ...
                                break;
                              case DW_TAG_SCOUT_frame_type:
                                clang_type = CreateFrameType (decl_ctx,
                                                              accessibility,
                                                              type_name_cstr,
                                                              class_language,
                                                              &metadata);
...
size_t
ClangASTContext::ParseMeshChildMembers
(
 const SymbolContext& sc,
 SymbolFileDWARF *dwarf,
 DWARFCompileUnit* dwarf_cu,
...
size_t
ClangASTContext::ParseFrameChildMembers
(
 const SymbolContext& sc,
 SymbolFileDWARF *dwarf,
 DWARFCompileUnit* dwarf_cu,
