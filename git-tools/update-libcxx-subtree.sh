...
if [ ! -d llvm/projects/libcxx ]; then 
    echo "Unable to find llvm/projects/libcxx in current working directory."
    exit 1;
fi 
...
git subtree pull --squash -d -P llvm/projects/libcxx http://llvm.org/git/libcxx.git master 
