...
// in Scout. 
extern void initialize_mesh(UniMesh*);
extern void heat_transfer(UniMesh*);

// ----- main
//
int main(int argc, char *argv[])
{
  UniMesh heat_mesh[MESH_SIZE, MESH_SIZE]; // Two-dimensional instance of the uniform mesh.
